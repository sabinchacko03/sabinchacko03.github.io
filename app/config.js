...
export let experiences = [
  {
    ...
    mainTech: ["Laravel", "MS SQL Server"],
    technologies: [
      "AlpineJS",
      "Tailwind CSS",
      "Livewire",
  ...
  },
  {
    ...
    title: "Web Developer",
    years: "04/2019 - 07/2021",
    location: "Dubai, UAE",
    mainTech: ["Laravel", "Concrete5", "Yii2"],
    technologies: [
      "PHP",
      "JQuery",
      "JavaScript",
  ...
  },
  {
    ...
    years: "09/2015 - 10/2017",
    location: "Kerala, India",
    mainTech: ["PHP", "Wordpress", "Python"],
    technologies: ["JQuery", "MySQL", "Shell"],
    jobDetails:
      "Managed company websites using wordpress and a php CLI program for LCR in Telecommunication. Used socket programming and rewrote the entire program to Python. Developed interactive web interfaces in Wordpress using JQuery. Developed wordpress plugins.",
  },
  {
    company: "Infinite Open Source Solutions",
    title: "Web Developer",
    years: "11/2013 - 08/2015",
    location: "Kerala, India",
